...
const promptRows = [
  {
    direction: "left",
    prompts: [
      { text: "Best boutique hotels in Santorini with sea view?", logo: ChatGPTLogo, color: "text-emerald-400" },
      { text: "Where to eat authentic ramen in Tokyo?", logo: ClaudeLogo, color: "text-orange-400" },
      { text: "Top family-friendly resorts in Bali under $200/night?", logo: GeminiLogo, color: "text-blue-400" },
      { text: "Best guided hiking tours in Patagonia?", logo: PerplexityLogo, color: "text-violet-400" },
      { text: "Romantic restaurants in Paris near the Eiffel Tower?", logo: CopilotLogo, color: "text-pink-400" },
      { text: "Best surf schools in Portugal for beginners?", logo: ChatGPTLogo, color: "text-emerald-400" },
      { text: "Where to find the best street food in Bangkok?", logo: ClaudeLogo, color: "text-orange-400" },
      { text: "Eco-friendly lodges in Costa Rica rainforest?", logo: GeminiLogo, color: "text-blue-400" },
    ],
  },
  {
    direction: "right",
    prompts: [
      { text: "Best rooftop bars in Barcelona?", logo: GeminiLogo, color: "text-blue-400" },
      { text: "Where to go whale watching in Iceland?", logo: PerplexityLogo, color: "text-violet-400" },
      { text: "Affordable safari lodges in Kenya?", logo: CopilotLogo, color: "text-pink-400" },
      { text: "Best scuba diving spots in the Maldives?", logo: ChatGPTLogo, color: "text-emerald-400" },
      { text: "Traditional ryokans near Mount Fuji?", logo: ClaudeLogo, color: "text-orange-400" },
      { text: "Wine tasting tours in Tuscany with transport?", logo: GeminiLogo, color: "text-blue-400" },
      { text: "Best beach clubs in Mykonos?", logo: PerplexityLogo, color: "text-violet-400" },
      { text: "Where to see Northern Lights in Norway?", logo: CopilotLogo, color: "text-pink-400" },
    ],
  },
  {
    direction: "left",
    prompts: [
      { text: "Best all-inclusive resorts in Cancún?", logo: CopilotLogo, color: "text-pink-400" },
      { text: "Luxury train journeys in Switzerland?", logo: ChatGPTLogo, color: "text-emerald-400" },
      { text: "Where to rent a villa in Amalfi Coast?", logo: ClaudeLogo, color: "text-orange-400" },
      { text: "Best food tours in Lisbon?", logo: GeminiLogo, color: "text-blue-400" },
      { text: "Top adventure activities in Queenstown?", logo: PerplexityLogo, color: "text-violet-400" },
      { text: "Boutique hotels in Marrakech with pool?", logo: CopilotLogo, color: "text-pink-400" },
      { text: "Best cooking classes in Florence?", logo: ChatGPTLogo, color: "text-emerald-400" },
      { text: "Where to kayak in Dubrovnik?", logo: ClaudeLogo, color: "text-orange-400" },
    ],
  },
];
  ...
  return (
    ...
    >
      <div 
        ...
        style={{
          background: `linear-gradient(var(--flow-angle, 0deg), hsl(330 100% 60% / 0.8), hsl(280 80% 60% / 0.6), hsl(25 100% 55% / 0.5), hsl(330 100% 60% / 0.8))`,
